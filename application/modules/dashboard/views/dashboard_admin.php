					...
					<table class="table table-bordered table-sm table-striped">
					  <thead>                  
						<tr>
						  ...
						  <th style="text-align:center">Total Data Sertifikat</th>
						</tr>
					  </thead>
					  <tbody>
						<?php foreach($data_kelas as $kelas){
							$kode=isset($kelas->kode)?($kelas->kode):'';?>
						<tr>
						  <td><?php echo isset($kelas->kelas)?($kelas->kelas):''; ?></td>
						  <td style="text-align:center"><?php echo $cekSer=$this->db->get_where("data_sertifikat",array("kelas"=>$kode))->num_rows(); ?></td>
						</tr>
						<?php }?>
					  </tbody>
					</table>
