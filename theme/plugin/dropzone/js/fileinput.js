...
(function (factory) {
                    ...
                    if ($h.isEmpty(data) || $h.isEmpty(data.error)) {
                        ...
                        self._setPreviewError($thumb, i, self.filestack[i], self.retryErrorUploads);
						  formdata.append(csrf_token, csrf_hash);
							formdata.append("trpersyaratan_id", trpersyaratan_id);
							formdata.append("namapersyaratan", namapersyaratan);
    ...
    $.fn.fileinputLocales.en = {
        ...
        dropZoneTitle: 'Browse atau drag & drop persyaratan kesini &hellip;',
